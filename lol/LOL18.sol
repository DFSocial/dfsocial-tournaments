...
contract LOL18 is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    /* Constants and Mains */
    uint constant tournament_type = 1 ;
    string public constant tournament_name = 'LOL #18';
    string public constant start_date = '22nd Jan - 15:00 UTC';
    ...
    /* UNIX date when register finish: 21st Jan 20:00 UTC */
    uint public register_date = 1642795200; 

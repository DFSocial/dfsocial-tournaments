...
contract VAL6 is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    /* Constants and Mains */
    uint constant tournament_type = 1 ;
    string public constant tournament_name = 'Valorant #6';
    string public constant start_date = '11th Dec - 15:00 UTC';
    ...
    uint public constant playersPerTeam = 5;
    uint public maxParticipants = 32;
    uint public numParticipants;
    
    /* UNIX date when register finish: 10th Dec 23:59 UTC */
    uint public register_date = 1639180740; 

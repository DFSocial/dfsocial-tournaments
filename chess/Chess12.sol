...
contract Chess12 is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    /* Constants and Mains */
    uint constant tournament_type = 1 ;
    string public constant tournament_name = 'Chess #12';
    string public constant start_date = '20th Jan - 18:00 UTC';
    ...
    /* UNIX date when register finish: 19th Jan 20:00 UTC */
    uint public register_date = 1642622400; 

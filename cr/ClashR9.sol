...
contract ClashR9 is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    /* Constants and Mains */
    uint constant tournament_type = 1 ;
    string public constant tournament_name = 'Clash Royale #9';
    string public constant start_date =  '17th Mar - 15:00 UTC';
    uint public prizepool = 0;
    uint public poolPerUser = 10000000000000000000;
    ...
    uint public maxParticipants = 100;
    uint public numParticipants;
    
    /* UNIX date when register finish: 16th Mar 23:59 UTC */
    uint public register_date = 1647475199;

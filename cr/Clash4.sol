...
contract Clash4 is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    /* Constants and Mains */
    uint constant tournament_type = 1 ;
    string public constant tournament_name = 'Clash Royale #4';
    string public constant start_date = '21st Jan - 15:00 UTC';
    ...
    /* UNIX date when register finish: 20th Jan 20:00 UTC */
    uint public register_date = 1642708800; 
